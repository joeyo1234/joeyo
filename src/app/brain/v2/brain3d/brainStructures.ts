...
export const brainStructures: Record<string, BrainStructure> = {
  ...
  Right_Hemisphere_transparent: {
    meshName: 'Right_Hemisphere_transparent',
    name: 'Cerebral Cortex',
    category: 'cortical',
    description: 'The wrinkled outer layer of the brain — only 2-4mm thick but containing ~16 billion neurons. Divided into frontal lobe (planning, personality, motor), parietal lobe (spatial, sensory), temporal lobe (auditory, memory, language), and occipital lobe (vision). The cortex is where conscious experience happens — all higher cognitive functions emerge from cortical processing and cortico-cortical connections.',
    clinical: 'Cortical damage produces specific deficits depending on location: frontal (personality change, planning deficits), parietal (spatial neglect, apraxia), temporal (amnesia, language disorders), occipital (blindness). The specificity of cortical deficits was the original evidence for functional localization in the brain.',
    relatedModules: ['visual', 'auditory', 'spatial', 'phonological', 'semantic', 'syntactic', 'workingmem', 'executive', 'motor'],
    color: '#888',
  },
};

// Which structures activate for each task — captures the real neuroscience
// without forcing structures into single-module buckets
export const taskStructureActivations: Record<string, string[]> = {
  reading: ['Right_Hemisphere_transparent', 'Left_hippocampus1', 'Cingulate_gyrus_right', 'Right_thalamus'],
  speech: ['Right_Hemisphere_transparent', 'Right_cerebellar_hemisphere1', 'Left_insula', 'Caudate_nucleus1', 'Right_thalamus', 'Brain_stem55'],
  math: ['Right_Hemisphere_transparent', 'Cingulate_gyrus_right', 'Left_hippocampus1', 'Caudate_nucleus1'],
  listening: ['Right_Hemisphere_transparent', 'Right_thalamus', 'Amygdala1', 'Left_insula'],
  writing: ['Right_Hemisphere_transparent', 'Right_cerebellar_hemisphere1', 'Left_hippocampus1', 'Cingulate_gyrus_right', 'Caudate_nucleus1'],
  attention: ['Cingulate_gyrus_right', 'Right_thalamus', 'Right_thalamus1', 'Amygdala1', 'Right_Hemisphere_transparent'],
  decision: ['Amygdala1', 'Left_hippocampus1', 'Cingulate_gyrus_right', 'Left_insula', 'Caudate_nucleus1', 'Right_Hemisphere_transparent'],
  problemsolving: ['Right_Hemisphere_transparent', 'Left_hippocampus1', 'Cingulate_gyrus_right'],
  conversation: ['Right_Hemisphere_transparent', 'Amygdala1', 'Left_hippocampus1', 'Left_insula', 'Right_cerebellar_hemisphere1', 'Right_thalamus'],
  creative: ['Right_Hemisphere_transparent', 'Left_hippocampus1', 'Amygdala1', 'Cingulate_gyrus_right', 'Caudate_nucleus1'],
  navigation: ['Left_hippocampus1', 'Right_Hemisphere_transparent', 'Right_cerebellar_hemisphere1', 'Cingulate_gyrus_right'],
  running: ['Right_cerebellar_hemisphere1', 'Right_Hemisphere_transparent', 'Caudate_nucleus1', 'Left_putamen1', 'Brain_stem55', 'Pons', 'Amygdala1'],
  startle: ['Amygdala1', 'Superior_colliculus', 'Hypothalamus_and_pituitary1', 'Brain_stem55', 'Right_thalamus', 'Cingulate_gyrus_right'],
  recall: ['Left_hippocampus1', 'Amygdala1', 'Right_Hemisphere_transparent', 'Cingulate_gyrus_right', 'Fornix_right', 'Mammillary_bodies1'],
  skilllearning: ['Right_cerebellar_hemisphere1', 'Caudate_nucleus1', 'Left_putamen1', 'Right_Hemisphere_transparent', 'Cingulate_gyrus_right'],
  transcendence: ['Left_insula', 'Amygdala1', 'Left_hippocampus1', 'Cingulate_gyrus_right'],
  trauma: ['Amygdala1', 'Hypothalamus_and_pituitary1', 'Left_hippocampus1', 'Cingulate_gyrus_right', 'Left_insula', 'Brain_stem55'],
  dreaming: ['Left_hippocampus1', 'Amygdala1', 'Right_Hemisphere_transparent', 'Pons', 'Right_thalamus', 'Right_cerebellar_hemisphere1'],
};
