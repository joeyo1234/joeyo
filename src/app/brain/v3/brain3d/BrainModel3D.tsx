...
export default function BrainModel3D(props: BrainModel3DProps) {
  ...
  if (glbExists === false) {
    return (
      <div className="w-full rounded-xl border border-dashed flex items-center justify-center" style={{ height: 300, borderColor: 'var(--border)', background: 'var(--card)' }}>
  ...
  return (
    <div className="w-full rounded-xl border overflow-hidden" style={{ height: 450, borderColor: 'var(--border)', background: 'var(--card)' }}>
